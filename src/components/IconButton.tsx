...
function renderWorkspaceIcon(name: IconName): ReactNode {
  switch (name) {
    case 'profiles':
      return (
        <>
...
function renderActionIcon(name: IconName): ReactNode {
  switch (name) {
    case 'send':
      return (
        <>
...
function renderPanelIcon(name: IconName): ReactNode {
  switch (name) {
    case 'files':
      return (
        <>
...
function renderMiscIcon(name: IconName): ReactNode {
  switch (name) {
    case 'panelLeft':
      return (
        <>
...
function Icon({ name, ...props }: { name: IconName } & SVGProps<SVGSVGElement>) {
  const content =
    renderWorkspaceIcon(name) ??
    renderActionIcon(name) ??
    renderPanelIcon(name) ??
    renderMiscIcon(name)
  if (!content) {
    return null
  }
