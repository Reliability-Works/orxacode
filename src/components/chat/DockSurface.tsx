      ...
      <div className="dock-surface-panel">
        {(title !== undefined ||
          ...
          <div className="dock-surface-header">
            {icon ? (
              <span className="dock-surface-icon" aria-hidden="true">
                {icon}
              </span>
            ) : null}
        ...
        <div className={`dock-surface-body ${bodyClassName ?? ''}`.trim()}>{children}</div>
        {footer ? <div className="dock-surface-footer">{footer}</div> : null}
      </div>
    </div>
  )
}
