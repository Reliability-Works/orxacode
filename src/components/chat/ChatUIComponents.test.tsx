...
describe('MessagePartRenderer', () => {
  ...
  it('renders file attachment for file type', () => {
    render(<MessagePartRenderer part={{ type: 'file', filename: 'report.pdf' }} role="user" />)
...
describe('FollowupDock', () => {
  ...
  it('calls onSelect with suggestion text when chip is clicked', () => {
    ...
    render(<FollowupDock suggestions={['Fix the bug', 'Add tests']} onSelect={onSelect} />)
  ...
  it('applies .followup-chip class to each chip', () => {
    render(<FollowupDock suggestions={['one', 'two', 'three']} onSelect={() => {}} />)
