import { Eye, FileEdit, FolderOpen, Globe, ListTodo, Search, Terminal, Wrench } from 'lucide-react'
const TOOL_ICON_RULES: Array<{
  keywords: string[]
  icon: 'terminal' | 'write' | 'read' | 'search' | 'browser' | 'list' | 'todo'
}> = [
