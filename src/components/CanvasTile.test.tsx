...
function renderTile(tileOverrides: Partial<CanvasTile> = {}, handlers: { onUpdate?: (id: string, patch: Partial<CanvasTile>) => void; onRemove?: (id: string) => void; onBringToFront?: (id: string) => void } = {}) {
...
describe("CanvasTileComponent", () => {
  ...
  it("maximize button toggles maximized state", () => {
    ...
    expect(onUpdate).toHaveBeenCalledWith("tile-1", expect.objectContaining({ maximized: true, minimized: false }));
  });
