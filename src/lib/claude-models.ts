...
export function getClaudeReasoningEffortOptions(model: string | null | undefined): ReadonlyArray<ClaudeChatEffort> {
...
export function normalizeClaudeModelOptions(
  ...
  const effort =
    ...
    options.effort !== defaultEffort
      ? options.effort
      : undefined;
  const thinking = supportsClaudeThinkingToggle(model) && options?.thinking === false ? false : undefined;
