...
describe('app-session-utils', () => {
  ...
  it('handles session title helpers', () => {
    ...
    expect(shouldAutoRenameSessionTitle('OpenCode Session')).toBe(true)
    expect(shouldAutoRenameSessionTitle('My task')).toBe(false)
    expect(looksAutoGeneratedSessionTitle('Codex Session')).toBe(true)
    expect(looksAutoGeneratedSessionTitle('OpenCode Session')).toBe(true)
    expect(looksAutoGeneratedSessionTitle('019c9e0e-7f97-78f2-a719-d28af9fb76b6')).toBe(true)
    expect(looksAutoGeneratedSessionTitle('Manual rename')).toBe(false)
