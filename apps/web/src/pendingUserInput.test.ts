...
describe('pending user input question progress', () => {
  it('counts only answered questions', () => {
    expect(
      countAnsweredPendingUserInputQuestions(progressQuestions, {
        scope: {
          selectedOptionLabel: 'Orchestration-first',
        },
      })
  ...
  it('finds the first unanswered question', () => {
    expect(
      findFirstUnansweredPendingUserInputQuestionIndex(progressQuestions, {
        scope: {
          selectedOptionLabel: 'Orchestration-first',
        },
      })
  ...
  it('derives the active question and advancement state', () => {
    expect(
      ...
      questionIndex: 0,
      activeQuestion: progressQuestions[0],
      selectedOptionLabel: 'Orchestration-first',
      customAnswer: '',
