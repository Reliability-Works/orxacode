...
describe('getComposerProviderState codex defaults', () => {
...
describe('getComposerProviderState codex explicit options', () => {
...
describe('getComposerProviderState Claude effort and prompt modes', () => {
...
describe('getComposerProviderState Claude dispatch defaults', () => {
...
describe('getComposerProviderState Claude context windows', () => {
