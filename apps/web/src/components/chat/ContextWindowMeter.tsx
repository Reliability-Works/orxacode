...
function ContextWindowMeterButton(props: {
  ...
  const { usage, usedPercentage, circumference, dashOffset, radius } = props
  return (
    <button
      type="button"
...
function ContextWindowMeterDetails(props: {
  usage: ContextWindowSnapshot
  usedPercentage: string | null
}) {
  ...
  return (
    <Popover>
      ...
      <PopoverPopup tooltipStyle side="top" align="end" className="w-max max-w-none px-3 py-2">
        <ContextWindowMeterDetails usage={usage} usedPercentage={usedPercentage} />
      </PopoverPopup>
    </Popover>
  )
}
