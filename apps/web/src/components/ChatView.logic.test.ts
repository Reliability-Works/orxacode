...
function createBaselineLocalDispatch() {
  return createLocalDispatchSnapshot({
...
describe('waitForStartedServerThread immediate and subscribed starts', () => {
...
describe('waitForStartedServerThread races and timeouts', () => {
...
describe('hasServerAcknowledgedLocalDispatch before turn/session changes', () => {
  it('does not clear local dispatch before server state changes', () => {
    const localDispatch = createBaselineLocalDispatch()
...
describe('hasServerAcknowledgedLocalDispatch after acknowledged changes', () => {
