...
import { OPENCODE_LOGO_VIEWBOX, OpenCodeLogoPaths } from './session/ProviderLogos'
...
function VisualStudioCodeMaskedContent(props: {
  maskId: string
  topShadowFilterId: string
  sideShadowFilterId: string
  overlayGradientId: string
}) {
  return (
    <g mask={`url(#${props.maskId})`}>
      <path
        fill="#0065A9"
      ...
      />
      <g filter={`url(#${props.topShadowFilterId})`}>
        <path
          fill="#007ACC"
      ...
      <g filter={`url(#${props.sideShadowFilterId})`}>
        <path
          fill="#1F9CF0"
      ...
      <path
        fill={`url(#${props.overlayGradientId})`}
        fillRule="evenodd"
...
function VscodeShadowFilter(props: {
  id: string
  width: string
  height: string
  x: string
...
function VisualStudioCodeDefs(props: {
  maskId: string
  topShadowFilterId: string
  sideShadowFilterId: string
  overlayGradientId: string
  ...
  return (
    <>
      <mask id={props.maskId} width="100" height="100" x="0" y="0" maskUnits="userSpaceOnUse">
        <path
          fill="#fff"
          fillRule="evenodd"
...
export const VisualStudioCode: Icon = props => {
  ...
  return (
    <svg {...props} fill="none" viewBox="0 0 100 100">
      <VisualStudioCodeDefs
        maskId={maskId}
        topShadowFilterId={topShadowFilterId}
        sideShadowFilterId={sideShadowFilterId}
        overlayGradientId={overlayGradientId}
      />
      <VisualStudioCodeMaskedContent
        maskId={maskId}
        topShadowFilterId={topShadowFilterId}
        sideShadowFilterId={sideShadowFilterId}
        overlayGradientId={overlayGradientId}
...
function GeminiBlurFilter(props: {
  id: string
  width: string
  height: string
  x: string
  ...
  return (
    ...
    >
      ...
      <feGaussianBlur result="effect1_foregroundBlur_69_17998" stdDeviation={props.stdDeviation} />
    </filter>
  )
}
...
const GEMINI_DEFS = (
  <defs>
    <GeminiBlurFilter id="gemini__b" width="464" height="390" x="-69" y="-46" stdDeviation={18} />
    <GeminiBlurFilter id="gemini__c" width="265" height="273" x="-99" y="6" stdDeviation={32} />
    <GeminiBlurFilter id="gemini__d" width="265" height="273" x="-113" y="12" stdDeviation={32} />
    <GeminiBlurFilter
      id="gemini__e"
      width="299.5"
      height="329"
    ...
    <GeminiBlurFilter
      ...
      stdDeviation={32}
    />
    <GeminiBlurFilter id="gemini__g" width="299.5" height="329" x="-41" y="91" stdDeviation={32} />
    <GeminiBlurFilter id="gemini__h" width="299.5" height="329" x="-39" y="132" stdDeviation={32} />
  </defs>
)
...
export const OpenCodeIcon: Icon = props => (
  <svg {...props} viewBox={OPENCODE_LOGO_VIEWBOX} fill="none" xmlns="http://www.w3.org/2000/svg">
    <OpenCodeLogoPaths />
  </svg>
)
