...
describe('estimateTimelineMessageHeight assistant sizing', () => {
...
describe('estimateTimelineMessageHeight attachment sizing', () => {
...
describe('estimateTimelineMessageHeight user content sizing', () => {
...
describe('estimateTimelineMessageHeight responsive widths', () => {
