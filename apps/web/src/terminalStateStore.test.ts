...
describe('terminalStateStore default state', () => {
...
describe('terminalStateStore terminal splitting', () => {
...
describe('terminalStateStore new terminal groups', () => {
...
describe('terminalStateStore terminal activity', () => {
...
describe('terminalStateStore terminal closing', () => {
