...
function ChatThreadShell(props: { threadId: ThreadId }) {
  return (
...
function ChatThreadInlineLayout(props: {
  threadId: ThreadId
  diffOpen: boolean
  onCloseDiff: () => void
  onOpenDiff: () => void
...
function ChatThreadSheetLayout(props: {
  threadId: ThreadId
  diffOpen: boolean
  onCloseDiff: () => void
  renderDiffContent: boolean
