...
describe('terminalContext labels and blocks', () => {
...
describe('terminalContext extraction and display state', () => {
...
describe('terminalContext previews and placeholders', () => {
...
describe('terminalContext filtering and inline materialization', () => {
