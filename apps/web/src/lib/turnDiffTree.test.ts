...
describe('buildTurnDiffTree nested structure', () => {
...
describe('buildTurnDiffTree stat handling', () => {
...
describe('buildTurnDiffTree path normalization', () => {
...
describe('buildTurnDiffTree directory compaction', () => {
...
describe('buildTurnDiffTree whitespace preservation', () => {
