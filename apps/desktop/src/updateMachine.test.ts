...
describe('updateMachine check state', () => {
...
describe('updateMachine download and install failures', () => {
...
describe('updateMachine no-update resets', () => {
...
describe('updateMachine availability and progress', () => {
