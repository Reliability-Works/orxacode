...
export const rpcRequestsTotal = Metric.counter('orxa_rpc_requests_total', {
  description: 'Total RPC requests handled by the websocket RPC server.',
})

export const rpcRequestDuration = Metric.timer('orxa_rpc_request_duration', {
  description: 'RPC request handling duration.',
})

export const orchestrationCommandsTotal = Metric.counter('orxa_orchestration_commands_total', {
  description: 'Total orchestration commands dispatched.',
})

export const orchestrationCommandDuration = Metric.timer('orxa_orchestration_command_duration', {
  description: 'Orchestration command dispatch duration.',
})

export const orchestrationCommandAckDuration = Metric.timer(
  'orxa_orchestration_command_ack_duration',
  {
    description:
...
export const orchestrationEventsProcessedTotal = Metric.counter(
  'orxa_orchestration_events_processed_total',
  {
    description: 'Total orchestration intent events processed by runtime reactors.',
  }
)

export const providerSessionsTotal = Metric.counter('orxa_provider_sessions_total', {
  description: 'Total provider session lifecycle operations.',
})

export const providerTurnsTotal = Metric.counter('orxa_provider_turns_total', {
  description: 'Total provider turn lifecycle operations.',
})

export const providerTurnDuration = Metric.timer('orxa_provider_turn_duration', {
  description: 'Provider turn request duration.',
})

export const providerRuntimeEventsTotal = Metric.counter('orxa_provider_runtime_events_total', {
  description: 'Total canonical provider runtime events processed.',
})

export const gitCommandsTotal = Metric.counter('orxa_git_commands_total', {
  description: 'Total git commands executed by the server runtime.',
})

export const gitCommandDuration = Metric.timer('orxa_git_command_duration', {
  description: 'Git command execution duration.',
})

export const terminalSessionsTotal = Metric.counter('orxa_terminal_sessions_total', {
  description: 'Total terminal sessions started.',
})

export const terminalRestartsTotal = Metric.counter('orxa_terminal_restarts_total', {
