...
const UNHANDLED_SCALAR = Symbol('unhandled-scalar')

function normalizeScalarValue(value: unknown): unknown | typeof UNHANDLED_SCALAR {
  if (
    value === null ||
    value === undefined ||
    typeof value === 'string' ||
