...
function makeUpsertProjectionThreadSessionRow(sql: SqlClient.SqlClient) {
...
function makeGetProjectionThreadSessionRow(sql: SqlClient.SqlClient) {
...
function makeDeleteProjectionThreadSessionRow(sql: SqlClient.SqlClient) {
  return SqlSchema.void({
...
const makeProjectionThreadSessionRepository = Effect.gen(function* () {
  ...
  const upsertProjectionThreadSessionRow = makeUpsertProjectionThreadSessionRow(sql)
  const getProjectionThreadSessionRow = makeGetProjectionThreadSessionRow(sql)
  const deleteProjectionThreadSessionRow = makeDeleteProjectionThreadSessionRow(sql)
