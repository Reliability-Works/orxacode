...
import { ChatAttachment } from '@orxa-code/contracts'
...
function makeUpsertProjectionThreadMessageRow(sql: SqlClient.SqlClient) {
...
function makeGetProjectionThreadMessageRow(sql: SqlClient.SqlClient) {
...
function makeListProjectionThreadMessageRows(sql: SqlClient.SqlClient) {
...
function makeDeleteProjectionThreadMessageRows(sql: SqlClient.SqlClient) {
  return SqlSchema.void({
...
const makeProjectionThreadMessageRepository = Effect.gen(function* () {
  ...
  const upsertProjectionThreadMessageRow = makeUpsertProjectionThreadMessageRow(sql)
  const getProjectionThreadMessageRow = makeGetProjectionThreadMessageRow(sql)
  const listProjectionThreadMessageRows = makeListProjectionThreadMessageRows(sql)
  const deleteProjectionThreadMessageRows = makeDeleteProjectionThreadMessageRows(sql)
