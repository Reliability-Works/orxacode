...
function makeUpsertProjectionThreadProposedPlanRow(sql: SqlClient.SqlClient) {
...
function makeListProjectionThreadProposedPlanRows(sql: SqlClient.SqlClient) {
...
function makeDeleteProjectionThreadProposedPlanRows(sql: SqlClient.SqlClient) {
  return SqlSchema.void({
...
const makeProjectionThreadProposedPlanRepository = Effect.gen(function* () {
  ...
  const upsertProjectionThreadProposedPlanRow = makeUpsertProjectionThreadProposedPlanRow(sql)
  const listProjectionThreadProposedPlanRows = makeListProjectionThreadProposedPlanRows(sql)
  const deleteProjectionThreadProposedPlanRows = makeDeleteProjectionThreadProposedPlanRows(sql)
  ...
  const deleteByThreadId: ProjectionThreadProposedPlanRepositoryShape['deleteByThreadId'] = input =>
