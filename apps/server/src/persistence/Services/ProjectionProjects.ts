 ...
 */
import { IsoDateTime, ModelSelection, ProjectId, ProjectScript } from '@orxa-code/contracts'
...
>()('orxacode/persistence/Services/ProjectionProjects/ProjectionProjectRepository') {}
