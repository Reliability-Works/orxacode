...
const TestLayer = Layer.empty.pipe(
  ...
  Layer.provide(
    ServerConfig.layerTest(process.cwd(), {
      prefix: 'orxa-workspace-files-test-',
    })
  ),
...
it.layer(TestLayer)('WorkspaceFileSystemLive writeFile', it => {
  describe('writeFile', () => {
...
it.layer(TestLayer)('WorkspaceFileSystemLive path guards', it => {
  describe('writeFile', () => {
