...
import type { ChatAttachment, ModelSelection } from '@orxa-code/contracts'
...
export interface TextGenerationService {
  generateCommitMessage(input: CommitMessageGenerationInput): Promise<CommitMessageGenerationResult>
...
export class TextGeneration extends ServiceMap.Service<TextGeneration, TextGenerationShape>()(
  'orxacode/git/Services/TextGeneration'
) {}
